...
#     print (repr("".join(i_to_c(input_example[0].numpy()))))
#     print (repr("".join(i_to_c(target_example[0].numpy()))))
...
if (cellType == "LSTM"):
    ...
    rnn = tf.keras.layers.LSTM  # tf.keras.layers.CudnnLSTM
elif (cellType == "GRU"):
...
# model2.add(tf.keras.layers.TimeDistributed(tf.keras.layers.Dense(vocab_size)))
